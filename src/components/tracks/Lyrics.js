...
class Lyrics extends Component {
    ...
    componentDidMount() {
        ...
        fetch(`https://cors-anywhere.herokuapp.com/http://api.musixmatch.com/ws/1.1/track.lyrics.get?track_id=${
              id
            ...
            return (
                <React.Fragment>
                  ...
                  <ul className="list-group mt-3">
                    ...
                    <li className="list-group-item">
                      <strong>Url:</strong>{' '}
                      <a href={track.track_edit_url} target='_blank' rel='noopener noreferrer'>Look at the full lyrics</a>
                      </li>
                  </ul>
                </React.Fragment>)
        }
